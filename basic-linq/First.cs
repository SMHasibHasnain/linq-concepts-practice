...
var FirstEntrepreneur = persons.First(person => person.Job == "Entrepreneur");
var LastEngineer = persons.Last(person => person.Job == "Engineer");

Console.WriteLine($"{nameof(FirstPerson)} = {FirstPerson.Name}");
Console.WriteLine($"{nameof(FirstEntrepreneur)} = {FirstEntrepreneur.Name}");
Console.WriteLine($"{nameof(LastEngineer)} = {LastEngineer.Name}");
